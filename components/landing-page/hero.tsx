  ...
  return (
    <section className="relative z-10 flex flex-col items-center justify-center px-4 py-24 text-center lg:py-32 overflow-hidden">
      <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 flex flex-col items-center space-y-8 max-w-4xl">
        ...
        <h1 className="text-5xl font-bold tracking-tight text-[#1d1d1f] sm:text-7xl leading-[1.1] drop-shadow-2xl">Sign In to Start Editing<br />
          <span className="text-[#ffffff] drop-shadow-2xl">
            ac.Stock
          </span>
        </h1>
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:gap-6 pt-4 w-full items-center justify-center">
          <Link href="/auth/login">
            ...
            <Button size="lg" className="relative min-w-[180px] h-12 rounded-full text-base font-medium bg-[#0071e3] text-white hover:bg-[#0077ed] border-0 shadow-none transition-all hover:scale-[1.02]">
              LogIn
              <LogIn className="absolute right-4 h-4 w-4" />
            </Button>
          </Link>
          <Link href="/features">
            <Button size="lg" variant="outline" className="relative min-w-[180px] h-12 rounded-full text-base font-medium border-[#0071e3] text-[#0071e3] bg-transparent hover:bg-[#0071e3]/5 transition-all hover:scale-[1.02]">
              <BarChart2 className="absolute left-4 h-4 w-4" />
              View Features
            </Button>
          </Link>
        </div>
